...
const T: Record<Lang, Dict> = {
  es: {
    ...
    ctaLabel: "Ya a la venta",
    ctaTitle: "La tienda ya está abierta.",
    ctaSub: "AOLELIM ya vende online. ¿Quieres una tienda que venda así desde el día uno?",
  ...
  en: {
    ...
    ctaLabel: "Now live",
    ctaTitle: "The store is live.",
    ctaSub: "AOLELIM is now selling online. Want a store that sells like this from day one?",
  ...
  de: {
    ...
    ctaLabel: "Jetzt live",
    ctaTitle: "Der Shop ist live.",
    ctaSub: "AOLELIM verkauft jetzt online. Willst du einen Shop, der ab Tag eins so verkauft?",
