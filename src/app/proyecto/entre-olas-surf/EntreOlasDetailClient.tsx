    ...
    <div style={{ background: BG, color: TEXT, fontFamily: SANS }}>
      ...
      >
        ...
        <div className="relative">
          ...
          {/* Datos del camp — a lo ancho */}
          <div className="mt-12 md:mt-16 grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-8">
            {t.campStats.map((f) => (
          ...
          {/* La villa: vídeo + fotos de la casa, misma altura */}
          <motion.div
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-3 md:gap-4 md:h-[420px]">
              {/* Vídeo vertical (autoplay · loop · mudo · control solo de audio) */}
              <div
                className="relative w-full max-w-[248px] mx-auto md:mx-0 aspect-[9/16] md:aspect-auto md:h-full shrink-0 overflow-hidden rounded-xl"
              ...
              >
                ...
                <button
                  ...
                  className="absolute bottom-3 right-3 h-10 w-10 rounded-full flex items-center justify-center transition hover:scale-105"
              ...
              {/* Fotos de la casa, misma altura que el vídeo */}
              <div className="relative w-full aspect-[3/2] md:aspect-auto md:h-full md:flex-1 overflow-hidden rounded-lg" style={{ background: NAVY_SOFT }}>
                <Image src="/projects/entre-olas-surf/casa-017.jpg" alt="Casa del surf camp en Roche" fill sizes="(max-width: 768px) 100vw, 35vw" quality={82} className="object-cover" />
              </div>
              <div className="relative w-full aspect-[3/2] md:aspect-auto md:h-full md:flex-1 overflow-hidden rounded-lg" style={{ background: NAVY_SOFT }}>
                <Image src="/projects/entre-olas-surf/casa-020.jpg" alt="Villa del surf camp · +1000 m²" fill sizes="(max-width: 768px) 100vw, 35vw" quality={82} className="object-cover" />
              </div>
            </div>
          </motion.div>
