...
export const metadata: Metadata = {
  alternates: { canonical: "/proyecto/la-inquieta" },
  openGraph: { url: "https://felippecamara.com/proyecto/la-inquieta", type: "article", images: ["/projects/la-inquieta/cartel.png"] },
