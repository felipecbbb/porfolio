...
export const metadata: Metadata = {
  alternates: { canonical: "/proyecto/samba-trips" },
  openGraph: { url: "https://felippecamara.com/proyecto/samba-trips", type: "article", images: ["/projects/samba-trips/hero-surf.jpg"] },
