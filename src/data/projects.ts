...
export const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    description: {
      es: "Web multipágina para David W. Coffe, coach de mindset y hábitos con +275K de comunidad. Paleta bloqueada de 2 colores, fotografía en blanco y negro y modelo de sesiones de pago 1 a 1 — sin embudo de llamada gratis.",
      en: "Multi-page website for David W. Coffe, a mindset & habits coach with a 275K+ community. Locked two-colour palette, black-and-white photography and a paid 1-on-1 session model — no free-call funnel.",
      de: "Mehrseitige Website für David W. Coffe, Mindset- & Gewohnheits-Coach mit einer Community von über 275K. Festgelegte Zwei-Farben-Palette, Schwarz-Weiß-Fotografie und ein bezahltes 1-zu-1-Sitzungsmodell — ohne Gratis-Call-Funnel.",
    },
    tags: ["HTML5", "CSS3", "JavaScript", "SEO", "Multipágina", "Sin dependencias"],
    metrics: {
      es: "7 páginas · Comunidad +275K · davidwcoffe.com",
      en: "7 pages · 275K+ community · davidwcoffe.com",
      de: "7 Seiten · Community +275K · davidwcoffe.com",
    },
    year: "2026",
  ...
  },
  {
    ...
    category: {
      es: "Web + RRSS — Coctelería de autor",
      en: "Web + Social — Signature cocktail bar",
      de: "Web + Social — Signature-Cocktailbar",
    },
    description: {
      es: "Web completa, carta digital y reservas de eventos para una coctelería de autor con destilería propia en Russafa, Valencia. Diseño, desarrollo y gestión de redes — todo de la misma mano.",
      en: "Full website, digital menu and event bookings for a signature cocktail bar with its own distillery in Russafa, Valencia. Design, development and social — all from one hand.",
      de: "Komplette Website, digitale Karte und Event-Buchungen für eine Signature-Cocktailbar mit eigener Destillerie in Russafa, Valencia. Design, Entwicklung und Social — alles aus einer Hand.",
    },
    tags: ["Next.js", "TypeScript", "Tailwind", "Resend", "Vercel", "RRSS", "Bilingüe"],
    metrics: {
      es: "Web + carta digital + reservas · Bilingüe ES/EN · Great Taste 2025",
      en: "Website + digital menu + bookings · ES/EN bilingual · Great Taste 2025",
      de: "Website + digitale Karte + Buchungen · ES/EN zweisprachig · Great Taste 2025",
    },
    year: "2026",
    client: "Lunin Cocktail Bar · Russafa, Valencia",
    liveUrl: "https://luninbar.com",
    longDescription: {
      es: "Lunin es una coctelería de autor con destilería propia (Lunin Distillery, Ucrania) en pleno Russafa, Valencia — galardonada con una estrella en los Great Taste 2025. Me encargué de su presencia digital de principio a fin: diseñé y desarrollé la web (carta digital, reservas de eventos privados, about y contacto), monté el sistema de correos transaccionales y un panel de administración para gestionar carta y solicitudes, y además llevo la gestión de sus redes sociales. Una sola persona detrás de la marca, la web y el contenido — sin intermediarios ni teléfono roto.",
      en: "Lunin is a signature cocktail bar with its own distillery (Lunin Distillery, Ukraine) right in Russafa, Valencia — awarded a Great Taste 2025 star. I handled its entire digital presence: I designed and built the website (digital menu, private-event bookings, about and contact), set up the transactional email system and an admin panel to manage the menu and requests, and I also run its social media. One person behind the brand, the site and the content — no middlemen, no broken telephone.",
      de: "Lunin ist eine Signature-Cocktailbar mit eigener Destillerie (Lunin Distillery, Ukraine) mitten in Russafa, Valencia — ausgezeichnet mit einem Great-Taste-2025-Stern. Ich verantwortete die gesamte digitale Präsenz: Ich gestaltete und entwickelte die Website (digitale Karte, Buchungen für Privatevents, About und Kontakt), baute das transaktionale E-Mail-System und ein Admin-Panel zur Verwaltung von Karte und Anfragen — und betreue zusätzlich die Social-Media-Kanäle. Eine Person hinter Marke, Website und Content — ohne Mittelsmänner.",
    },
    challenge: {
      es: "Lunin tenía un producto premium y un local con encanto, pero su carta vivía en papel y las reservas de eventos se perdían entre DMs y llamadas. Necesitaban una web bilingüe (ES/EN) a la altura de la marca, una carta digital fácil de actualizar y accesible por QR en mesa, y una forma ordenada de recibir y gestionar solicitudes de eventos privados — sin depender de plataformas de terceros con comisiones.",
      en: "Lunin had a premium product and a charming venue, but its menu lived on paper and event requests got lost between DMs and phone calls. They needed a bilingual (ES/EN) website worthy of the brand, a digital menu that was easy to update and reachable by QR at the table, and an orderly way to receive and manage private-event requests — without relying on third-party platforms taking a cut.",
      de: "Lunin hatte ein Premium-Produkt und ein charmantes Lokal, aber die Karte lag auf Papier und Event-Anfragen gingen zwischen DMs und Anrufen verloren. Es brauchte eine zweisprachige (ES/EN) Website auf Markenniveau, eine leicht aktualisierbare, per QR am Tisch erreichbare digitale Karte und einen geordneten Weg, Anfragen für Privatevents zu empfangen und zu verwalten — ohne Drittplattformen mit Provisionen.",
    },
    solution: {
      es: "Construí la web en Next.js + TypeScript + Tailwind con la identidad de Lunin (negro, oro y crema, serif Alice). La carta es una single-page con navegación sticky scroll-spy y ficha de cada cóctel en modal a pantalla completa; se edita desde un panel /admin sin tocar código. La sección de eventos es una landing de reservas privadas con formulario validado (tipo de evento, fecha, invitados, contacto), honeypot anti-bot y correos transaccionales vía Resend desde el dominio propio — cada solicitud llega al bar y queda en una bandeja del panel con estados (Nueva → Contactado → Confirmada). Generé también los QR para mesa y barra. Y mantengo las redes con contenido a juego con la marca.",
      en: "I built the site in Next.js + TypeScript + Tailwind with Lunin's identity (black, gold and cream, Alice serif). The menu is a single page with sticky scroll-spy navigation and a full-screen modal for each cocktail; it's edited from an /admin panel with no code. The events section is a private-booking landing with a validated form (event type, date, guests, contact), an anti-bot honeypot and transactional emails via Resend from the bar's own domain — each request reaches the bar and lands in an admin inbox with statuses (New → Contacted → Confirmed). I also generated the table and bar QR codes. And I keep the social channels running with on-brand content.",
      de: "Ich baute die Site mit Next.js + TypeScript + Tailwind in Lunins Identität (Schwarz, Gold und Creme, Alice-Serife). Die Karte ist eine Single-Page mit Sticky-Scroll-Spy-Navigation und Vollbild-Modal je Cocktail; sie wird über ein /admin-Panel ohne Code bearbeitet. Der Event-Bereich ist eine Landing für Privatbuchungen mit validiertem Formular (Eventtyp, Datum, Gäste, Kontakt), Anti-Bot-Honeypot und transaktionalen E-Mails via Resend von der eigenen Domain — jede Anfrage erreicht die Bar und landet in einem Admin-Postfach mit Status (Neu → Kontaktiert → Bestätigt). Ich erstellte auch die QR-Codes für Tisch und Theke. Und ich betreibe die Social-Kanäle mit markenkonformem Content.",
    },
    results: {
      es: [
        "Web bilingüe (ES/EN) en producción: luninbar.com",
        "Carta digital con 70+ productos en 10 categorías, editable desde panel propio",
        "Carta accesible por QR en mesa y barra (PDFs listos para imprimir)",
        "Landing de reservas de eventos con formulario validado + honeypot anti-bot",
        "Correos transaccionales con Resend desde dominio verificado (reservas@luninbar.com)",
        "Panel /admin con bandeja de solicitudes y estados de seguimiento",
        "Gestión continua de redes sociales con contenido alineado a la marca",
        "Stack: Next.js · TypeScript · Tailwind · Resend · Vercel",
      ],
      en: [
        "Bilingual (ES/EN) website live: luninbar.com",
        "Digital menu with 70+ products across 10 categories, editable from a custom panel",
        "Menu reachable by QR at the table and bar (print-ready PDFs)",
        "Event-booking landing with validated form + anti-bot honeypot",
        "Transactional emails with Resend from a verified domain (reservas@luninbar.com)",
        "/admin panel with a request inbox and follow-up statuses",
        "Ongoing social media management with on-brand content",
        "Stack: Next.js · TypeScript · Tailwind · Resend · Vercel",
      ],
      de: [
        "Zweisprachige (ES/EN) Website live: luninbar.com",
        "Digitale Karte mit 70+ Produkten in 10 Kategorien, über eigenes Panel editierbar",
        "Karte per QR an Tisch und Theke erreichbar (druckfertige PDFs)",
        "Event-Buchungs-Landing mit validiertem Formular + Anti-Bot-Honeypot",
        "Transaktionale E-Mails mit Resend von verifizierter Domain (reservas@luninbar.com)",
        "/admin-Panel mit Anfragen-Postfach und Follow-up-Status",
        "Laufendes Social-Media-Management mit markenkonformem Content",
        "Stack: Next.js · TypeScript · Tailwind · Resend · Vercel",
      ],
    },
    features: {
      es: [
        "Carta single-page con nav sticky scroll-spy + modal de detalle",
        "Reservas de eventos privados con formulario validado y anti-bot",
        "Emails transaccionales (Resend) con plantilla a juego con la marca",
        "Panel /admin: editor de carta, de eventos y bandeja de reservas",
        "Bilingüe ES/EN con sistema de traducción propio",
        "Fotografía de producto y cócteles integrada en la carta",
        "QR para mesa y barra apuntando a la carta digital",
        "Identidad: negro + oro + crema, tipografía serif Alice",
      ],
      en: [
        "Single-page menu with sticky scroll-spy nav + detail modal",
        "Private-event bookings with a validated, anti-bot form",
        "Transactional emails (Resend) with an on-brand template",
        "/admin panel: menu editor, events editor and booking inbox",
        "Bilingual ES/EN with a custom translation system",
        "Product and cocktail photography integrated into the menu",
        "Table and bar QR codes pointing to the digital menu",
        "Identity: black + gold + cream, Alice serif typography",
      ],
      de: [
        "Single-Page-Karte mit Sticky-Scroll-Spy-Nav + Detail-Modal",
        "Privatevent-Buchungen mit validiertem, Anti-Bot-Formular",
        "Transaktionale E-Mails (Resend) mit markenkonformer Vorlage",
        "/admin-Panel: Karten-Editor, Event-Editor und Buchungs-Postfach",
        "Zweisprachig ES/EN mit eigenem Übersetzungssystem",
        "Produkt- und Cocktail-Fotografie in die Karte integriert",
        "Tisch- und Theken-QR-Codes zur digitalen Karte",
        "Identität: Schwarz + Gold + Creme, Alice-Serifenschrift",
      ],
    },
    theme: {
      bg: "#0d0d0d",
      ...
      tagBg: "rgba(222,171,59,0.15)",
      tagText: "#e8be5a",
      heroGradient:
        "linear-gradient(135deg, #0d0d0d 0%, #1f1f1f 55%, #deab3b30 100%)",
    },
    gallery: [
      {
        label: { es: "Carta digital", en: "Digital menu", de: "Digitale Karte" },
        description: {
          es: "Single-page con scroll-spy y ficha de cada cóctel en modal; editable desde el panel sin tocar código.",
          en: "Single page with scroll-spy and a modal for each cocktail; editable from the panel with no code.",
          de: "Single-Page mit Scroll-Spy und Modal je Cocktail; über das Panel ohne Code editierbar.",
        },
      },
      {
        label: { es: "Reservas de eventos", en: "Event bookings", de: "Event-Buchungen" },
        description: {
          es: "Landing con formulario validado, honeypot anti-bot y aviso por email al instante vía Resend.",
          en: "Landing with a validated form, anti-bot honeypot and instant email alert via Resend.",
          de: "Landing mit validiertem Formular, Anti-Bot-Honeypot und sofortiger E-Mail-Benachrichtigung via Resend.",
        },
      },
      {
        label: { es: "Panel de administración", en: "Admin panel", de: "Admin-Panel" },
        description: {
          es: "Bandeja de solicitudes con estados, editor de carta y de eventos — gestión sin depender de nadie.",
          en: "Request inbox with statuses, menu and events editors — self-managed, no dependencies.",
          de: "Anfragen-Postfach mit Status, Karten- und Event-Editor — eigenständig verwaltet.",
        },
      },
      {
        label: { es: "Identidad & redes", en: "Identity & social", de: "Identität & Social" },
        description: {
          es: "Negro, oro y crema con serif Alice; contenido de redes a juego con la marca premium del bar.",
          en: "Black, gold and cream with Alice serif; social content matching the bar's premium brand.",
          de: "Schwarz, Gold und Creme mit Alice-Serife; Social-Content passend zur Premium-Marke der Bar.",
        },
      },
    ],
  },
  {
    ...
    title: "ÍCARO",
    category: {
      es: "E-commerce — Sneakers artesanales",
      en: "E-commerce — Handcrafted sneakers",
      de: "E-Commerce — Handgefertigte Sneaker",
    },
    description: {
      es: "Tienda online a medida en Shopify para ÍCARO, sneakers hechas a mano en Portugal. Tema custom minimalista, bilingüe, con drops, feed de Instagram y reseñas.",
      en: "Custom Shopify storefront for ÍCARO, handmade sneakers from Portugal. Bespoke minimalist theme, bilingual, with drops, Instagram feed and reviews.",
      de: "Maßgeschneiderter Shopify-Store für ÍCARO, handgefertigte Sneaker aus Portugal. Eigenes minimalistisches Theme, zweisprachig, mit Drops, Instagram-Feed und Reviews.",
    },
    tags: ["Shopify", "Liquid", "JavaScript", "CSS", "i18n", "E-commerce"],
    metrics: {
      es: "Tema Shopify a medida · Bilingüe ES/EN · DROP 000",
      en: "Bespoke Shopify theme · ES/EN bilingual · DROP 000",
      de: "Eigenes Shopify-Theme · ES/EN zweisprachig · DROP 000",
    },
    year: "2026",
    client: "ÍCARO · icarolab.es",
    liveUrl: "https://www.icarolab.es",
    featuredImage: "/projects/icaro/cover.jpg",
    longDescription: {
      es: "ÍCARO es una marca joven de sneakers premium hechas a mano en Portugal y nacidas en España — «hechas a mano, una a una». Les construí la tienda online desde cero: un tema de Shopify a medida en Liquid, no una plantilla. Estética minimalista en blanco y negro, bilingüe (ES/EN), con carrusel hero, tira de producto, drop grid para lanzamientos limitados, página de producto con variantes (color y talla), feed de Instagram, reseñas estilo Trustpilot, club de socios y secciones de lanzamientos y devoluciones.",
      en: "ÍCARO is a young premium sneaker brand handmade in Portugal and born in Spain — \"handmade, one by one\". I built their online store from scratch: a bespoke Shopify theme in Liquid, not a template. Minimalist black-and-white aesthetic, bilingual (ES/EN), with a hero carousel, product strip, drop grid for limited launches, a product page with variants (color and size), Instagram feed, Trustpilot-style reviews, a members club and launches and returns sections.",
      de: "ÍCARO ist eine junge Premium-Sneaker-Marke, handgefertigt in Portugal und geboren in Spanien — „handgefertigt, Stück für Stück\". Ich baute ihren Online-Shop von Grund auf: ein maßgeschneidertes Shopify-Theme in Liquid, keine Vorlage. Minimalistische Schwarz-Weiß-Ästhetik, zweisprachig (ES/EN), mit Hero-Karussell, Produktstreifen, Drop-Grid für limitierte Launches, Produktseite mit Varianten (Farbe und Größe), Instagram-Feed, Trustpilot-Style-Reviews, Mitglieder-Club sowie Launch- und Rückgabe-Bereichen.",
    },
    challenge: {
      es: "Una marca artesanal recién nacida no podía venderse con una plantilla genérica de Shopify: el producto es premium, minimalista y de tirada limitada, y la web tenía que transmitir exactamente eso. Necesitaban una tienda que respirara «hecho a mano», que vendiera drops limitados, que funcionara en español e inglés y que se gestionara sola desde el editor de Shopify sin tocar código.",
      en: "A brand-new artisanal label couldn't sell itself with a generic Shopify template: the product is premium, minimalist and limited-run, and the site had to convey exactly that. They needed a store that breathed \"handmade\", that sold limited drops, worked in Spanish and English and could be managed from the Shopify editor with no code.",
      de: "Ein brandneues handwerkliches Label konnte sich nicht mit einer generischen Shopify-Vorlage verkaufen: Das Produkt ist premium, minimalistisch und limitiert, und die Site musste genau das vermitteln. Sie brauchten einen Store, der „handgemacht\" atmet, limitierte Drops verkauft, auf Spanisch und Englisch läuft und sich ohne Code über den Shopify-Editor verwalten lässt.",
    },
    solution: {
      es: "Desarrollé un tema de Shopify completo en Liquid con secciones configurables desde el editor: hero carrusel, tira de producto, drop grid con huecos para componer el layout, vídeo, feed de Instagram y bloque de reseñas. La página de producto soporta variantes de color y talla con widget de valoración. Todo bilingüe ES/EN con un sistema i18n propio, estética en blanco y negro con tipografía Inter, e imágenes optimizadas para que cargue rápido. Entregado con guía de instalación para que el cliente lo suba y lo edite sin depender de mí.",
      en: "I developed a full Shopify theme in Liquid with editor-configurable sections: hero carousel, product strip, drop grid with empty slots to compose the layout, video, Instagram feed and a reviews block. The product page supports color and size variants with a rating widget. All bilingual ES/EN with a custom i18n system, black-and-white aesthetic with Inter type, and optimized images for fast loading. Shipped with an install guide so the client can upload and edit it without depending on me.",
      de: "Ich entwickelte ein vollständiges Shopify-Theme in Liquid mit über den Editor konfigurierbaren Sektionen: Hero-Karussell, Produktstreifen, Drop-Grid mit leeren Slots zum Komponieren des Layouts, Video, Instagram-Feed und Reviews-Block. Die Produktseite unterstützt Farb- und Größenvarianten mit Bewertungs-Widget. Alles zweisprachig ES/EN mit eigenem i18n-System, Schwarz-Weiß-Ästhetik mit Inter-Schrift und optimierten Bildern für schnelles Laden. Mit Installationsanleitung übergeben, damit der Kunde es ohne mich hochladen und bearbeiten kann.",
    },
    results: {
      es: [
        "Tienda Shopify en producción: icarolab.es",
        "Tema 100% a medida en Liquid (no plantilla)",
        "Bilingüe ES/EN con sistema i18n propio",
        "Drop grid para lanzamientos limitados configurable desde el editor",
        "Página de producto con variantes (color/talla) y reseñas",
        "Feed de Instagram + bloque de reseñas estilo Trustpilot",
        "Club de socios, lanzamientos y devoluciones",
        "Entregado con guía de instalación para autogestión",
      ],
      en: [
        "Shopify store live: icarolab.es",
        "100% bespoke Liquid theme (not a template)",
        "Bilingual ES/EN with a custom i18n system",
        "Drop grid for limited launches, editor-configurable",
        "Product page with variants (color/size) and reviews",
        "Instagram feed + Trustpilot-style reviews block",
        "Members club, launches and returns",
        "Shipped with an install guide for self-management",
      ],
      de: [
        "Shopify-Store live: icarolab.es",
        "100% maßgeschneidertes Liquid-Theme (keine Vorlage)",
        "Zweisprachig ES/EN mit eigenem i18n-System",
        "Drop-Grid für limitierte Launches, über Editor konfigurierbar",
        "Produktseite mit Varianten (Farbe/Größe) und Reviews",
        "Instagram-Feed + Trustpilot-Style-Reviews-Block",
        "Mitglieder-Club, Launches und Rückgaben",
        "Mit Installationsanleitung zur Selbstverwaltung übergeben",
      ],
    },
    features: {
      es: [
        "Hero carrusel configurable con slides",
        "Drop grid con huecos para componer el layout",
        "Página de producto con variantes color/talla",
        "Feed de Instagram + reseñas estilo Trustpilot",
        "Bilingüe ES/EN (i18n propio)",
        "Club de socios + lanzamientos + devoluciones",
        "Estética minimalista B/N · tipografía Inter",
        "Imágenes optimizadas + guía de instalación",
      ],
      en: [
        "Configurable hero carousel with slides",
        "Drop grid with empty slots to compose the layout",
        "Product page with color/size variants",
        "Instagram feed + Trustpilot-style reviews",
        "Bilingual ES/EN (custom i18n)",
        "Members club + launches + returns",
        "Minimalist B/W aesthetic · Inter type",
        "Optimized images + install guide",
      ],
      de: [
        "Konfigurierbares Hero-Karussell mit Slides",
        "Drop-Grid mit leeren Slots zum Layout-Komponieren",
        "Produktseite mit Farb-/Größenvarianten",
        "Instagram-Feed + Trustpilot-Style-Reviews",
        "Zweisprachig ES/EN (eigenes i18n)",
        "Mitglieder-Club + Launches + Rückgaben",
        "Minimalistische S/W-Ästhetik · Inter-Schrift",
        "Optimierte Bilder + Installationsanleitung",
      ],
    },
    theme: {
      bg: "#ffffff",
      ...
      tagText: "#ffffff",
      heroGradient:
        "linear-gradient(135deg, #0a0a0a 0%, #2b2b2b 55%, #dbdbdb30 100%)",
    },
    gallery: [
      {
        label: { es: "Tema a medida", en: "Bespoke theme", de: "Eigenes Theme" },
        description: {
          es: "Tema Shopify en Liquid construido desde cero — secciones configurables desde el editor, sin plantilla.",
          en: "Shopify theme in Liquid built from scratch — editor-configurable sections, no template.",
          de: "Von Grund auf gebautes Shopify-Theme in Liquid — über Editor konfigurierbare Sektionen, keine Vorlage.",
        },
      },
      {
        label: { es: "Drops & producto", en: "Drops & product", de: "Drops & Produkt" },
        description: {
          es: "Drop grid para lanzamientos limitados y página de producto con variantes de color y talla.",
          en: "Drop grid for limited launches and a product page with color and size variants.",
          de: "Drop-Grid für limitierte Launches und Produktseite mit Farb- und Größenvarianten.",
        },
      },
      {
        label: { es: "Instagram & reseñas", en: "Instagram & reviews", de: "Instagram & Reviews" },
        description: {
          es: "Feed de Instagram integrado y bloque de reseñas estilo Trustpilot para reforzar la confianza.",
          en: "Integrated Instagram feed and a Trustpilot-style reviews block to build trust.",
          de: "Integrierter Instagram-Feed und Trustpilot-Style-Reviews-Block für mehr Vertrauen.",
        },
      },
      {
        label: { es: "Bilingüe & marca", en: "Bilingual & brand", de: "Zweisprachig & Marke" },
        description: {
          es: "Español e inglés con i18n propio, estética minimalista en blanco y negro fiel a «hecho a mano».",
          en: "Spanish and English with a custom i18n, minimalist black-and-white aesthetic true to \"handmade\".",
          de: "Spanisch und Englisch mit eigenem i18n, minimalistische Schwarz-Weiß-Ästhetik treu zu „handgemacht\".",
        },
      },
    ],
  },
